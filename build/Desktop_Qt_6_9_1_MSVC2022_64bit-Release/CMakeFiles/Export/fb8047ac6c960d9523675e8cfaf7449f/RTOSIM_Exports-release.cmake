...
# Import target "rtb::Common" for configuration "Release"
set_property(TARGET rtb::Common APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
...
# Import target "rtb::Utilities" for configuration "Release"
set_property(TARGET rtb::Utilities APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
...
# Import target "rtb::InputDevice" for configuration "Release"
set_property(TARGET rtb::InputDevice APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(rtb::InputDevice PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/InputDevice.lib"
  )
...
# Import target "rtb::OutputDevice" for configuration "Release"
set_property(TARGET rtb::OutputDevice APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(rtb::OutputDevice PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/OutputDevice.lib"
  )
...
# Import target "rtb::InverseKinematics" for configuration "Release"
set_property(TARGET rtb::InverseKinematics APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(rtb::InverseKinematics PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/InverseKinematics.lib"
  )
...
# Import target "rtb::InverseDynamics" for configuration "Release"
set_property(TARGET rtb::InverseDynamics APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(rtb::InverseDynamics PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/InverseDynamics.lib"
  )
...
# Import target "rtb::SignalProcessing" for configuration "Release"
set_property(TARGET rtb::SignalProcessing APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(rtb::SignalProcessing PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/SignalProcessing.lib"
  )
